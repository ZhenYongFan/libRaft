...
class CTestRaftPaperFixture :public CppUnit::TestFixture
{
    ...
    CPPUNIT_TEST(TestSendingSnapshotSetPendingSnapshot);
    CPPUNIT_TEST(TestPendingSnapshotPauseReplication);
    CPPUNIT_TEST(TestSnapshotFailure);
    CPPUNIT_TEST(TestSnapshotSucceed);
    CPPUNIT_TEST(TestSnapshotAbort);
...
public:
    ...
    void TestSendingSnapshotSetPendingSnapshot(void);
    void TestPendingSnapshotPauseReplication(void);
    void TestSnapshotFailure(void);
    void TestSnapshotSucceed(void);
    void TestSnapshotAbort(void);
